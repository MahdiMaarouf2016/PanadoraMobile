...
import pandora.ctg.NetworkConnectivity.NetworkConnection;
import pandora.ctg.NetworkConnectivity.NetworkError;
import pandora.ctg.PaymentGatWay;
...
public class Payment_fragment extends Fragment {
    ...
    private void Use_Wallet_Ammont() {
        ...
        if (NetworkConnection.connectionChecking(getActivity())) {
            ...
            StringRequest postReq = new StringRequest(Request.Method.POST, "http://pantest.tanvirazhar.com/index.php/api/wallet_on_checkout",
                            ...
                            try {
                                ...
                                for (int i = 0; i < Jarray.length(); i++) {
                                   ...
                                   //String Used_Wallet_amount = json_data.getString("used_wallet");
                                    ...
                                    used_wallet_ammount.setText("(" + getResources().getString(R.string.currency) + Wallet_Ammount + ")");
    ...
    private void checked() {
        if (checkBox_Wallet.isChecked()) {
            if (rb_Cod.isChecked()) {
                ...
                Toast.makeText(getActivity(), "Please Select Cash on Delivery", Toast.LENGTH_SHORT).show();
            }
        ...
        if (checkBox_coupon.isChecked()) {
            if (rb_Cod.isChecked()) {
                ...
                Toast.makeText(getActivity(), "Select Cod", Toast.LENGTH_SHORT).show();
            }
