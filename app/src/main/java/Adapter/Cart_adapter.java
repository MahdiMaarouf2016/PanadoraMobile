...
public class Cart_adapter extends RecyclerView.Adapter<Cart_adapter.ProductHolder> {
    ...
    public void onBindViewHolder(final ProductHolder holder, final int position) {
        ...
        Double reward = null;
        if (!map.get("rewards").equals(""))
            reward= Double.parseDouble(map.get("rewards"));
        holder.tv_total.setText("" + price * items);
        if (reward != null) holder.tv_reward.setText("" + reward * items);
        ...
        holder.tv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!map.get("rewards").equals(""))
                    reward = Double.parseDouble(map.get("rewards"));
                holder.tv_total.setText("" + price * items);
                holder.tv_reward.setText((reward != null) ? "" + reward * items : "0");
