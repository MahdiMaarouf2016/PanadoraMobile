...
public class BaseURL {
    static final String APP_NAME = "Pandora's Box";
    ...
    //public static String BASE_URL = "https://ctgbazaar.space/ctgbazaar.space/admin/";
     //public static String BASE_URL = "https://thecodecafe.in/gogrocer/";
    //public static String BASE_URL = "http://pandora.tanvirazhar.com/";
    public static String BASE_URL = "http://pantest.tanvirazhar.com/";
     //public static String BASE_URL =   "http://localhost::3306/test/";
    //public static String BASE_URL = "http://hiutul.tech/admin/";
    ...
    public static String SUB_CATEGORIES = BASE_URL + "index.php/api/get_categoriesz";
